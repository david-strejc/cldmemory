...
import { StdioServerTransport } from '@modelcontextprotocol/sdk/server/stdio.js'; // TOTO JE SPRÁVNÝ IMPORT!
import {
...
class MemoryMCPServer {
            ...
            try {
                switch (name) {
                    ...
                    case 'quick_search_memories': {
                        ...
                        // Use the search with scores functionality for quick Browse
                    ...
                    case 'analyze_memories': {
                        ...
                        const analysis = {
                            ...
                            byType: memories.reduce((acc, m) => {
                                (acc as Record<string, number>)[m.type] = ((acc as Record<string, number>)[m.type] || 0) + 1;
                                return acc;
    ...
    async start() {
        ...
        const transport = new StdioServerTransport(); // KLÍČOVÉ!
